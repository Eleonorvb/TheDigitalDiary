...
public class DiaryController {
    ...
    @GetMapping(path = "/{id}")
    public DiaryRest getTitle(@PathVariable String id){
    ...
    public List<DiaryRest> getDiaryByUserId(@PathVariable String id){
    ...
    @PostMapping
    public DiaryRest createDiary(@RequestBody DiaryRequestModel diaryDetails){
